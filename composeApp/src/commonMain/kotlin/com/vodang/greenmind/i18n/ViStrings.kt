...
val ViStrings = AppStrings("vi").apply {
    ...
    greenScoreShort = "Xanh"
    greenScoreLabel = "Điểm Xanh"
    walkDistanceShort = "Quãng đường di chuyển"
    energyShort = "Điện"
    wasteKgShort = "Rác tiêu thụ"
    ...
    campaignsTitle = "Chiến dịch"
    campaignsDesc = "Tham gia chiến dịch tình nguyện"
    ...
    volunteerEventsLabel = "Chiến dịch tham gia"
    volunteerEventsValue = "8"
    volunteerPointsLabel = "Điểm tích lũy"
    volunteerPointsValue = "1.240"
    volunteerEventsCardTitle = "🗓️ Chiến dịch đang diễn ra"
    volunteerUpcomingTitle = "📅 Chiến dịch sắp tới"
    ...
    volunteerPendingApproval = "Chờ duyệt"
    volunteerCheckInTooFar = { m -> "Bạn đang cách điểm chiến dịch ${m}m, cần ở trong bán kính cho phép để check-in." }
    volunteerLoading = "Đang tải chiến dịch…"
    volunteerLoadError = "Không thể tải chiến dịch"
    volunteerNoCampaigns = "Không có chiến dịch nào"
    ...
    blogCommentLabel = "Bình luận"
    blogComments = "bình luận"
    blogSponsored = "Chiến Dịch"
    blogSponsoredCta = "Xem sự kiện"
    blogCampaignBadge = "Chiến dịch"
    blogCampaignInfo = "Thông tin chiến dịch"
    blogViewCampaign = "Xem chiến dịch"
    ...
    // ── Household Dashboard ─────────────────────────────────────────────────────
    householdDashboard = "Hộ gia đình"
    ...
    environmentalImpactShort = "Tác động"
    ...
    viewAllItems = "Xem chi tiết"
    householdScansSection = "Quét của hộ"
    ...
    campaignActive = "🟢"
    campaignInactive = "📅"
    campaignsAllTab = "Tất cả"
    campaignsMyTab = "Chiến dịch của tôi"
    campaignsActiveTab = "Đang diễn ra"
    campaignsHistoryTab = "Lịch sử"
    ...
    wasteTotalMassTitle = "Khối lượng rác"
    wasteTotalMassDesc = "Theo dõi cân nặng rác thải"
    wasteTotalMassTotalKg = "Tổng rác thải"
    wasteTotalMassEstimated = "Giá trị ước tính"
    wasteTotalMassEmpty = "Chưa có dữ liệu khối lượng rác"
    wasteTotalMassHistory = "Lịch sử quét"
    wasteTotalMassDetailTitle = "Chi tiết quét"
    wasteTotalMassDetailStatus = "Trạng thái"
    wasteTotalMassDetailDate = "Ngày"
    wasteTotalMassDetailType = "Loại"
    wasteTotalMassDetailLocation = "Địa điểm"
    wasteTotalMassDetailObjects = "Số vật thể"
    wasteTotalMassDetailItems = "Phân loại rác"
    wasteTotalMassDetailAnalysis = "Phân tích AI"
    wasteTotalMassQuickScan = "Quét nhanh"
    wasteTotalMassQuickScanDesc = "Chụp hoặc chọn ảnh để ước tính khối lượng rác"
    wasteTotalMassProcessing = "Đang xử lý ảnh…"
    ...
    takePhoto = "Chụp ảnh"
    myScanReportsTitle = "Lịch sử quét"
    ...
    pollutantAnalysis = "Phân tích chất gây ô nhiễm"
    noDataYet = "—"
    noPollutantData = "Chưa có dữ liệu ô nhiễm"
    noPollutantsDetected = "Sạch!"
    cleanWaste = "Không có chất gây hại"
    pollutantsDetected = "chất ô nhiễm phát hiện"
    envImpact = "Tác động môi trường"
    airPollution = "Ô nhiễm không khí"
    waterPollution = "Ô nhiễm nước"
    soilPollution = "Ô nhiễm đất"
    pollutantDetails = "Chi tiết chất ô nhiễm"
    massAndItems = "Khối lượng & Vật thể"
    noMassData = "Chưa có dữ liệu khối lượng"
    ...
    paymentSubtitle = "Quản lý hoá đơn"
    paymentPending = "Chờ"
    paymentPaid = "Đã thanh toán"
    paymentAll = "Tất cả"
    paymentPendingAmount = "Chờ thanh toán"
    paymentPaidAmount = "Đã thanh toán"
    paymentNoPending = "Không có hoá đơn chờ"
    paymentNoPaid = "Không có hoá đơn đã thanh toán"
    paymentNoInvoices = "Chưa có hoá đơn"
    paymentAmount = "Số tiền"
    paymentDue = "Hạn"
    paymentPaidOn = "Đã thanh toán lúc"
    paymentItems = "mục"
    paymentPayNow = "Thanh toán ngay"
    paymentTotalAmount = "Tổng tiền"
    paymentInvoiceDetails = "Chi tiết hoá đơn"
    paymentDueDate = "Ngày hết hạn"
    paymentDescription = "Mô tả"
    paymentStripeSecure = "Bảo mật bởi Stripe"
    paymentPayWithStripe = "Thanh toán qua Stripe"
    paymentSuccessTitle = "Thanh toán thành công"
    paymentSuccessDesc = "Thanh toán của bạn đã được xử lý thành công."
    paymentStatusPending = "Chờ"
