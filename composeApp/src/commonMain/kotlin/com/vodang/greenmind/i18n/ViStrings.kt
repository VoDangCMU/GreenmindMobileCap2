...
val ViStrings = AppStrings(
    ...
    settingsSpeedFilterDesc     = { v -> "Chuyển động nhanh hơn ${"%.1f".format(v)} m/s bị coi là đi phương tiện" },
    ...
    settingsHowWorksBody        = { secs, meters, speed ->
        ...
        "Chuyển động nhanh hơn ${"%.1f".format(speed)} m/s bị loại bỏ là đi phương tiện."
    },
    ...
    billGreenAmount = { amt -> "Xanh: ${"%.2f".format(amt)}đ" },
