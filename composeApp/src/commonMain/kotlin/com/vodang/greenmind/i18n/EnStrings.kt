...
val EnStrings = AppStrings(
    ...
    settingsSpeedFilterDesc     = { v -> "Movements faster than ${"%.1f".format(v)} m/s are treated as vehicle travel" },
    ...
    settingsHowWorksBody        = { secs, meters, speed ->
        ...
        "Movements faster than ${"%.1f".format(speed)} m/s are excluded as vehicle travel."
    },
    ...
    billGreenAmount = { amt -> "Green: $${"%.2f".format(amt)}" },
